...
echo "Access project website - http://192.168.3.2/"
echo "MYSQL Server - 192.168.3.3:3306"
echo "Access phpmyadmin via - http://192.168.3.4/"
echo "Access email server via - http://192.168.3.5:8025/"
