...
* Access your project website via - http://192.168.3.2/
* MySQL can be accessed via 192.168.3.3:3306
* PhpMyAdmin can be accessed via http://192.168.3.4/
* Mailhog can be accessed via http://192.168.3.5:8025/
...
* For database connection -`DATABASE_URL=mysql://root:@192.168.3.3:3306/project`
...
* If you haven't modified IP addresses, you can connect to your MySQL via 192.168.3.3:3306
* If you don't have any additional software, you can connect to database via phpmyadmin (http://192.168.3.4/)
* Nickname: `root`
...
* You would need to modify `docker-compose.yml` IP addresses. For example from `192.168.3.0/24` to `192.168.3.0/24`
